...
Device (PDRC)
{
	...
	Name (PDRS, ResourceTemplate () {
		...
		/*
		 * No entry for the TPM range (0xfed40000-0xfed44fff): the TPM
		 * device generated by drivers/pc80/tpm declares it, and a
		 * duplicate reservation here makes Windows 98 report a
		 * resource conflict (code 15) on both devices.
		 */
		/*
		 * Misc ICH, split around the EDRAM and GDXC windows below:
		 * Windows 98 reports a resource conflict (code 15) when the
		 * ranges of a device overlap each other.
		 */
		Memory32Fixed (ReadWrite, 0xfed45000, 0x0003b000) // Misc ICH
		Memory32Fixed (ReadWrite, EDRAM_BASE_ADDRESS, EDRAM_BASE_SIZE)
		Memory32Fixed (ReadWrite, GDXC_BASE_ADDRESS, GDXC_BASE_SIZE)
		Memory32Fixed (ReadWrite, 0xfed85000, 0x0000b000) // Misc ICH
	})
